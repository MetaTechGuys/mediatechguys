...
import Captxt from "../components/Captxt/Captxt";
import Ccov from "../components/Ccov/Ccov";
...
export default function CapitalAddressGroupPage() {
  ...
  return (
    <div>
      ...
      <Ccov image="/images/capital.banner.v1.01.00.1404.06.24-09.webp" alt="Capital Address Group Cover" />
    </div>
  );
}
